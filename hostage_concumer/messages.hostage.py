...
class User(Base):
    ...
    content_hostage_suspicious = relationship("ContentHostageSuspicious", back_populates="user", uselist=False)


class ContentHostageSuspicious(Base):
    __tablename__ = 'content_hostage_suspicious'
    ...
    user = relationship("User", back_populates="content_hostage_suspicious")
...
for mail in consumer:
    ...
    try:
        ...
        user_details = ContentHostageSuspicious(
            user_id=user.id,
